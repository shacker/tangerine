...
urlpatterns = [
    ...
    path("<int:year>/<int:month>/<int:day>/", views.date_archive, name="date_archive"),
    path("<int:year>/<int:month>/", views.date_archive, name="date_archive"),
    path("<int:year>/", views.date_archive, name="date_archive"),
    ...
    path("manage/comments/<int:comment_id>", views.manage_comments, name="manage_comment"),
